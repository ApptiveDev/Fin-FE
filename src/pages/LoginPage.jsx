...
function KakaoButton() {
  return (
    <button className="flex items-center justify-center gap-2 bg-[#FEE500] hover:bg-yellow-200 text-[#51515] py-2.5 rounded-full transition-colors">
...
function GoogleButton() {
  return (
    <button className="flex items-center justify-center gap-2 bg-white hover:bg-gray-100 text-[#51515] py-2.5 rounded-full transition-colors">
